...
format: 
  dashboard:
    ...
    nav-buttons: 
      - icon: git
        href: https://codeberg.org/bbartholdy/os-survey-unileiden
...
responses_2025 <- readr::read_csv("data/2025_responses-wide.csv")
responses_2023 <- readr::read_csv("data/2023_responses-wide.csv")
...
output$question <- renderText({
  qualtRics:::remove_html(filter(questions, qname == input$questionInput)$question)
})
